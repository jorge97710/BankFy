  ...
  Widget build(BuildContext context) {
    ...
    Widget textSection = Container(
      ...
      child: Text.rich(
        TextSpan(
        children: <TextSpan> [
          TextSpan(text: 'Cuentra de Ahorro La Ahorradita', style: TextStyle(fontWeight: FontWeight.w900)),
          TextSpan(text: "\n\n"),
          TextSpan(text: "Beneficios:", style: TextStyle(fontWeight: FontWeight.w600)),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Tasa de interes del 0.1%"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Calculo de interes mensual sobre Q500"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Pago de interes semestral"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Libreta de ahorro y tarjeta de debito"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Atencion personalizada"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Disponibilidad inmediata"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "-Sorteos anuales"),
          TextSpan(text: "\n\n"),
          TextSpan(text: "\n\n"),
