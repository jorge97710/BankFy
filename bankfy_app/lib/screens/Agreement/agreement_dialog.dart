...
class CreateAgreement extends StatelessWidget {
  ...
  Welcome to Bankfy
	These terms and conditions outline the rules and regulations for the use of Bankfy's Website.  
	 Bankfy is located at: 
	Ciudad de Guatemala , Guatemala
	
	By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Bankfy's website 
	...
	of Guatemala. Any use of the above terminology or other words in the singular, plural,
	capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to same.Cookies
	We employ the use of cookies. By using Bankfy's website you consent to the use of cookies 
	in accordance with Bankfy's privacy policy.Most of the modern day interactive web sites
	use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
	to enable the functionality of this area and ease of use for those people visiting. Some of our 
	affiliate / advertising partners may also use cookies.License
	Unless otherwise stated, Bankfy and/or it's licensors own the intellectual property rights for
	all material on Bankfy. All intellectual property rights are reserved. You may view and/or print
	pages from https://github.com/jorge97710/BankFy for your own personal use subject to restrictions set in these terms and conditions.
	You must not:
	
		Republish material from https://github.com/jorge97710/BankFy
		Sell, rent or sub-license material from https://github.com/jorge97710/BankFy
		Reproduce, duplicate or copy material from https://github.com/jorge97710/BankFy
	
	Redistribute content from Bankfy (unless content is specifically made for redistribution).
Hyperlinking to our Content
	...
	the visibility associated with the hyperlink outweighs the absence of Bankfy; and (d) where the
	...
	you must notify us by sending an e-mail to bankfyc@gmail.com.
	...
	No use of Bankfy's logo or other artwork will be allowed for linking absent a trademark license
	agreement.
Iframes
...
Credit & Contact Information
	This Terms and conditions page was created at privacytermsgenerator.com generator. If you have
